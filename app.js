...
const countNumbersLowerThan501 = (accumulator, number) =>
    number < 501 ? ++accumulator : accumulator

const numbersLowerThan501 = crazyNumbers.reduce(countNumbersLowerThan501, 0)

console.log(numbersLowerThan501)
...
const moviesReleasedBefore2005 = tarantinoMovies.filter(({ release }) => {
    return release < 2000
})

console.log(moviesReleasedBefore2005)
...
const seriesName = tvShows.map(({ name }) => {
    return name
})
